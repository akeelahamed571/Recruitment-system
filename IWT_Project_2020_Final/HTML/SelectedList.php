...
<html>
  ...
  <body>
	...
	<br><br>
		...
		<h2 class="sList">Selected Lists</h2> <br><br><br>
        <img class="image1" src="../Images/selected.jpg">  </img>

		
<?php
	        
			$sql="SELECT * FROM selectedlists";
			...
			if($result->num_rows>0)
		    {
				...
				{	
					echo  "<div id='job1'><h2 id='jobRole'>"
					     ...
					     .$row["jobID"].")<h2><br><p class='ulList'>"
						 .$row["candidates"]."</p>
						  </div><br></br>";
				}
			}
