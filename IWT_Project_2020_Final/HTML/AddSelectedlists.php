...
<html>
  ...
  <head>
    <title>Add Selectedlists</title>
	<link rel="stylesheet" type="text/css" href="../CSS/homecss.css">
    <link rel="stylesheet" type="text/css" href="../CSS/selectedList.css">
  ...
  <body>
    ...
    <h2 class="sList">Add Selected List</h2> <br><br><br>

	<div id="formValue">
	
	<form  action="AddSelectedlists.php" method="post" target="_self">
	...
	Selected Candidates Names with ID<br>
	<textarea name="candidateD" rows="12" cols="10" style="width:500px" placeholder="Enter Selected Candidates Here" required></textarea>
	<br><br>

	<input type="submit" class="btn1" name="buttn1" value="Add Selected List" style="width:500px; height:28px"> <br><br><br>
...
<?php
    ...
    if(isset($_POST['buttn1']))
	{
      ...
      $sql="INSERT INTO selectedlists(vacancyName,jobID,candidates)VALUES('$VacancyName','$VacancyID','$CandidateNameId')";
