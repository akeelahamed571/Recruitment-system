...
<html>
  ...
  <body>
    ...
    <ul class="Menu" >
	  ...
	  <center>
	  <h1 id="Hiring">Welcome <?php echo $_SESSION["userName"] ?></h1>
	  ...
	  <div class="profile">
	   ...
	   <?php
	      ...
	      if(isset($_SESSION["userName"]))
          {
			...
			$sql="SELECT firstName,lastName,Position,Email,IMAGE FROM admin where userName='$userName'";
			...
			{   
				...
				{   
			        echo "<br><br>";
				    echo "<img width='350px' height='250px' src='data:image;base64,{$row["IMAGE"]}' alt='img'>";
					
					echo "<br><div class='pDetails'><h2 style='color:black'>"
					     .$row["firstName"]."&nbsp"
					     .$row["lastName"]."</h2><h3 style='color:black'><br>"
						 .$row["Position"]."<br>JOBFEST RECRUITMENT (PRIVATE) LIMITED
						  </h3></div>";
				}
			}
