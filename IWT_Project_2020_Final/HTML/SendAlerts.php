...
<html>
  ...
  <body> 
    ...
    <h2 class="sList">Send Alerts</h2> <br><br>

	<div id="formValue">
	
	<form  action="SendAlerts.php" method="post" target="_self">
     
	Company Name<br>
	<input type="text" name="CName"  style="width:500px; height:27px"  placeholder="Enter Company Name" required>
	<br><br>

	Vacancy<br>
	<input type="text" name="VName" style="width:500px; height:27px" placeholder="Enter Vacancy" required>
	<br><br>
    ...
    Description<br>
	<input type="text" name="JDescription" style="width:500px; height:27px" placeholder="Enter Description" required>
	<br><br>
	
    Date<br>
    <input type="date" name="pDate" required><br><br>
	
	<input type="submit" class="btn1" name="buttn1" value="Send Alerts" style="width:500px; height:28px"> <br><br><br>
...
<?php
   ...
   if(isset($_POST['buttn1']))
   {
     ...
     $sqli="INSERT INTO alerts(companyName,vacancyName,alertJobID,description,date)VALUES('$CompanyName','$VacancyName','$VacancyID','$Description','$Date')";
